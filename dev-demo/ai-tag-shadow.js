...
class AIElement extends HTMLElement {
  constructor() {
    ...
    this.shadow.appendChild(this.aiButton);
  ...
  //   if (this._script) {
  //     this.shadow.appendChild(this._script);
  //     this._script = null;
  //   }
  // }
  ...
  async chatApi() {
    ...
    try {
      ...
      //       { role: 'user', content: 'Change the background color of the webpage to red.' }
      //     ]
      //   })
      // });
...
You are a front-end developer and web designer. You will use your creativity and skills to modify the webpage based on the client's request.
...
Your response must STRICTLY follow this format:
 ...
 - It CANNOT include these tags: <html>, <head>, <body>, <img>, <a>, doctype declaration, or any head-related tags.
 - It could contain no more than one <style> tags, only when needed. The css in it is used to style the html content you provided.
